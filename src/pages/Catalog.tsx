...
const Catalog = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-brandon">
      ...
      <main className="container py-2 sm:py-8">
        {/* Page Header */}
        <div className="mb-1.5 sm:mb-8 animate-fade-in">
          <h1 className="font-brandon font-medium text-lg sm:text-3xl md:text-4xl font-bold text-foreground mb-0 sm:mb-2">
            {genderTitle}
          </h1>
          <p className="text-[11px] font-brandon font-medium sm:text-base text-muted-foreground">
